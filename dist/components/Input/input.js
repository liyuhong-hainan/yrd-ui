...
export var Input = forwardRef(function (props, ref) {
    ...
    var cnames = classNames('yrd-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: "yrd-input-group-prepend" }, prepend),
        icon && React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-".concat(icon) })),
        React.createElement("input", __assign({ ref: ref, className: "yrd-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "yrd-input-group-append" }, append)));
});
