...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "yrd-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "yrd-upload-list-item", key: item.uid },
