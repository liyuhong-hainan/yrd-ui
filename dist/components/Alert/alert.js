...
export var Alert = function (props) {
    ...
    var classes = classNames('yrd-alert', (_a = {},
        _a["yrd-alert-".concat(type)] = type,
        _a));
    var titleClass = classNames('yrd-alert-title', {
    ...
    return (React.createElement(Transition, { in: !hide, timeout: 300, animation: "zoom-in-top" },
        React.createElement("div", { className: classes },
            ...
            description && React.createElement("p", { className: "yrd-alert-desc" }, description),
            closable && React.createElement("span", { className: "yrd-alert-close", onClick: handleClose },
